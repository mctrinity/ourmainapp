...
<html lang="en">
  ...
  <body>
    ...
    <footer class="border-top text-center small text-muted py-3">
     <p class="m-0">Copyright &copy; <?php echo e(date('Y')); ?> <a href="/" class="text-muted">CloudVikings ☁️</a>. All rights reserved.</p>
    </footer>
...
</html><?php /**PATH /Volumes/HAGIBIS DRI/laravel-projects/ourmainapp/resources/views/components/layout.blade.php ENDPATH**/ ?>